...
class Simulator(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, ff_angles, ff_dihedrals):
    ...
    def forward(
        ...
        for i in range(n_steps):
            ...
            for ai, (atom_1, atom_2, atom_3, across_res) in enumerate(angles):
                ...
                print(angle_pots_to_use.shape)
                print(angle_bin_inds.shape)
                print(angle_bin_inds)

                angle_bin_inds = angle_bin_inds.view(1, 1, n_res)
...
def get_features(fp, device):
    ...
    return (
        ...
        node_f.to(device),
        inters_ang.to(device),
        inters_dih.to(device),
